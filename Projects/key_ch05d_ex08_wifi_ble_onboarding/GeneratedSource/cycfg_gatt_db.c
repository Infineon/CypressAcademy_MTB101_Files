...
const uint8_t gatt_database[] = 
{
    ...
    PRIMARY_SERVICE_UUID128 (HDLS_CUSTOM_SERVICE, __UUID_SERVICE_CUSTOM_SERVICE),
        ...
        CHARACTERISTIC_UUID128_WRITABLE (HDLC_CUSTOM_SERVICE_WIFI_SSID, HDLC_CUSTOM_SERVICE_WIFI_SSID_VALUE, __UUID_CHARACTERISTIC_CUSTOM_SERVICE_WIFI_SSID, LEGATTDB_CHAR_PROP_READ | LEGATTDB_CHAR_PROP_WRITE, LEGATTDB_PERM_VARIABLE_LENGTH | LEGATTDB_PERM_READABLE | LEGATTDB_PERM_WRITE_REQ),
            /* Descriptor: Characteristic User Description */
            CHAR_DESCRIPTOR_UUID16 (HDLD_CUSTOM_SERVICE_WIFI_SSID_CHAR_USER_DESCRIPTION, __UUID_DESCRIPTOR_CHARACTERISTIC_USER_DESCRIPTION, LEGATTDB_PERM_READABLE),
        /* Characteristic: WIFI PASSWORD */
        CHARACTERISTIC_UUID128_WRITABLE (HDLC_CUSTOM_SERVICE_WIFI_PASSWORD, HDLC_CUSTOM_SERVICE_WIFI_PASSWORD_VALUE, __UUID_CHARACTERISTIC_CUSTOM_SERVICE_WIFI_PASSWORD, LEGATTDB_CHAR_PROP_WRITE, LEGATTDB_PERM_VARIABLE_LENGTH | LEGATTDB_PERM_WRITE_REQ | LEGATTDB_PERM_AUTH_WRITABLE),
            /* Descriptor: Characteristic User Description */
            CHAR_DESCRIPTOR_UUID16 (HDLD_CUSTOM_SERVICE_WIFI_PASSWORD_CHAR_USER_DESCRIPTION, __UUID_DESCRIPTOR_CHARACTERISTIC_USER_DESCRIPTION, LEGATTDB_PERM_READABLE),
        /* Characteristic: WIFI CONNECTION */
        CHARACTERISTIC_UUID128_WRITABLE (HDLC_CUSTOM_SERVICE_WIFI_CONNECTION, HDLC_CUSTOM_SERVICE_WIFI_CONNECTION_VALUE, __UUID_CHARACTERISTIC_CUSTOM_SERVICE_WIFI_CONNECTION, LEGATTDB_CHAR_PROP_READ | LEGATTDB_CHAR_PROP_WRITE | LEGATTDB_CHAR_PROP_NOTIFY, LEGATTDB_PERM_READABLE | LEGATTDB_PERM_WRITE_REQ),
            /* Descriptor: Client Characteristic Configuration */
            CHAR_DESCRIPTOR_UUID16_WRITABLE (HDLD_CUSTOM_SERVICE_WIFI_CONNECTION_CLIENT_CHAR_CONFIG, __UUID_DESCRIPTOR_CLIENT_CHARACTERISTIC_CONFIGURATION, LEGATTDB_PERM_READABLE | LEGATTDB_PERM_WRITE_REQ),
            /* Descriptor: Characteristic User Description */
            CHAR_DESCRIPTOR_UUID16 (HDLD_CUSTOM_SERVICE_WIFI_CONNECTION_CHAR_USER_DESCRIPTION, __UUID_DESCRIPTOR_CHARACTERISTIC_USER_DESCRIPTION, LEGATTDB_PERM_READABLE),
};
...
uint8_t app_gap_device_name[]                                      = {'k', 'e', 'y', '_', 'p', 'r', 'o', 'v', };
