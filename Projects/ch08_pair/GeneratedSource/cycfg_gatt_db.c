...
const uint8_t gatt_database[] = 
{
    ...
    PRIMARY_SERVICE_UUID128 (HDLS_MODUS101, __UUID_SERVICE_MODUS101),
        ...
        CHARACTERISTIC_UUID128 (HDLC_MODUS101_COUNTER, HDLC_MODUS101_COUNTER_VALUE, __UUID_CHARACTERISTIC_MODUS101_COUNTER, LEGATTDB_CHAR_PROP_READ | LEGATTDB_CHAR_PROP_NOTIFY, LEGATTDB_PERM_READABLE | LEGATTDB_PERM_AUTH_READABLE),
            ...
            CHAR_DESCRIPTOR_UUID16_WRITABLE (HDLD_MODUS101_COUNTER_CLIENT_CHAR_CONFIG, __UUID_DESCRIPTOR_CLIENT_CHARACTERISTIC_CONFIGURATION, LEGATTDB_PERM_READABLE | LEGATTDB_PERM_WRITE_REQ | LEGATTDB_PERM_WRITE_CMD | LEGATTDB_PERM_AUTH_READABLE),
};
