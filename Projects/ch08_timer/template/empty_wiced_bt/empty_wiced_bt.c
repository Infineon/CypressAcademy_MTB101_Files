...
/*******************************************************************************
* Function Name: void timer_callback(TIMER_PARAM_TYPE cb_params)
********************************************************************************/
void timer_callback(TIMER_PARAM_TYPE cb_params)
{
...
wiced_result_t app_bt_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENABLED_EVT:
        ...
        wiced_init_timer(&my_timer, timer_callback, 0, WICED_MILLI_SECONDS_PERIODIC_TIMER);
        wiced_start_timer(&my_timer, TIMEOUT_500MS);
