...
/* TODO Ex 01: Include header files */
 ...
 ******************************************************************/
/* TODO: Ex 02: Add button interrupt callback function */
    ...
    switch( event )
    {
		case BTM_ENABLED_EVT:								// Bluetooth Controller and Host Stack Enabled
			if( WICED_BT_SUCCESS == p_event_data->enabled.status )
			{
                ...
                /* TODO Ex 02: Configure BUTTON_1 for a falling edge interrupt */
    ...
    for (i = 0; i < app_gatt_db_ext_attr_tbl_size; i++)
    {
        if (app_gatt_db_ext_attr_tbl[i].handle == attr_handle)
        {
            ...
            if (validLen)
            {
                ...
                // TODO Ex 02: Add code to print message when notifications are enabled/disabled
